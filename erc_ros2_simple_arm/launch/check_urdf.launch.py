...
def generate_launch_description():
    ...
    pkg_erc_ros2_simple_arm = FindPackageShare('erc_ros2_simple_arm')
    default_rviz_config_path = PathJoinSubstitution([pkg_erc_ros2_simple_arm, 'rviz', 'urdf.rviz'])
    ...
    # URDF model path within the erc_ros2_simple_arm package
    ...
    urdf = IncludeLaunchDescription(
        ...
        launch_arguments={
            'urdf_package': 'erc_ros2_simple_arm',
